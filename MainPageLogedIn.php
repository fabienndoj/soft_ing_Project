...
$query="SELECT moviePoster,movieName,movieId FROM movie WHERE movieYear=2019 ORDER BY movieIMDB DESC LIMIT 6";
...
while($row=mysqli_fetch_array($result)){
    ...
    echo '  <div class="Element">
                    ...
                    <div class="Element__nameAndInput">
                        ...
                        echo'<input type="submit" names="Rate" class="ratingSelect" value="Rate"';
